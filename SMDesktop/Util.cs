...
namespace SMDesktop
{
    public class Utilidades
    {
        ...
        public void FormataData(TextBox txtBox)
        {
            // Obtém o texto atual do TextBox
            string text = txtBox.Text;

            // Remove caracteres não numéricos do texto
            string numericText = new string(text.ToCharArray().Where(c => char.IsDigit(c)).ToArray());

            // Formata o texto no formato dd/MM/yyyy
            if (numericText.Length >= 8)
            {
                string formattedText = $"{numericText.Substring(0, 2)}/{numericText.Substring(2, 2)}/{numericText.Substring(4, 4)}";
                txtBox.Text = formattedText;
            }
        }

        public void FormataAnoMes(TextBox txtBox)
        {
            // Obtém o texto atual do TextBox
            string text = txtBox.Text;
            ...
            {
                string formattedText = $"{numericText.Substring(0, 2)}/{numericText.Substring(2, 4)}";
                txtBox.Text = formattedText;
            }
        }

        public void LimpaFormulario(Form formulario)
        {
            ...
            foreach (Control control in formulario.Controls)
            {
                ...
                // Adicione outros tipos de controle, se necessário, como RadioButton, DateTimePicker, etc.
            }
        }
